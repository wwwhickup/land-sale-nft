...
contract MultiverseMetaLand is Initializable, ERC721AUpgradeable, ERC721ABurnableUpgradeable, ERC2981Upgradeable, OwnableUpgradeable {
  ...
  function mmlInit() public initializer{
    __ERC721ABurnableMock_init("Multiverse Meta Land","MML");
    ...
    merkleRoot = 0x592916eaff17dc919281fb1dbb9d5aebbe42104610485f1315f823ef1379af2e;
  ...
  function whitelistMint(bytes32[] calldata _merkleProof, uint256 _quantity, uint256 _landSize) external payable mintCompliance(_quantity, _landSize) {
  ...
  function setMintRates(uint256 _landSize, uint256 _number) public onlyOwner {
  ...
  function setMaxMints(uint256 _number) public onlyOwner {
    MAX_MINTS = _number;
  }

  function setMaxParcels(uint256 _number) public onlyOwner {
    MAX_PARCELS = _number;
  }
