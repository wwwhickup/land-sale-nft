...
async function main() {
  ...
  const MultiverseMetaLand = await hre.ethers.getContractFactory("MultiverseMetaLand")
  const multiverseMetaLand = await MultiverseMetaLand.deploy()
  await multiverseMetaLand.deployed()
  console.log("gg")
//   const transactionResponse = await multiverseMetaLand.store(1)
